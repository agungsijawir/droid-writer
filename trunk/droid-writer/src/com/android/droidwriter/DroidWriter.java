...
public class DroidWriter extends LinearLayout implements SelectionChangedListener {
	...
	public DroidWriter(Context context) {
		this(context, null);
	}
	
	public DroidWriter(Context context, AttributeSet attrs) {
		super(context, attrs);
		((Activity)getContext())
				.getLayoutInflater()
				.inflate(R.layout.writer_layout, this, true);
